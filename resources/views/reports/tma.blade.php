...
<main id="main" class="main main-display">
    <div class="pagetitle">
        <h1 class="text-capitalize">TMA Report</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/">Dashboard</a></li>
                <li class="breadcrumb-item active text-capitalize">TMA Report</li>
            </ol>
        </nav>
    </div>
