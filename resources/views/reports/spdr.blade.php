...
<main id="main" class="main main-display">
    <div class="pagetitle">
        <h1 class="text-capitalize">SPDR Report</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/">Dashboard</a></li>
                <li class="breadcrumb-item active text-capitalize">SPDR Report</li>
            </ol>
        </nav>
    </div>
...
<script>
    ...
    const mainRoute = 'report/regular';
                ...
                data.forEach(element => {
                    if(element.leave.length > 0) {
                        element.leave.forEach(el => {
                            if(element.division_id == `2` && el.archive === null && (el.employee_id != 79)) {
                                bodyLeave += `
                                <tr>
                                    <td>${no}</td>
