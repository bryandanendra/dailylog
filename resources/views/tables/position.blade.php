...
@section('title', 'Position - Daily Log System')
...
@section('content')
<div class="pagetitle">
    <h1 class="text-capitalize">Position</h1>
</div>
    ...
    <div class="row">
        <div class="card">
            <div class="card-body pt-3">
                <h4 class="text-capitalize mb-4">Manage Position</h4>
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <div class="d-flex gap-2">
                        <button type="button" id="btn-add" class="btn btn-sm btn-primary"><i class="bi bi-plus-lg"></i>&nbsp;Add Position</button>
                    </div>
                    <div class="search-bar">
                        <div class="search-data d-flex align-items-center">
                            <input type="text" id="search" class="search" placeholder="Search Position" title="Enter search keyword">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="positionForm">
                    ...
                    <div class="mb-3">
                        <label for="position-title" class="form-label">Position Name <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="position-title" required>
                    </div>
                    <div class="mb-3">
                        <label for="position-description" class="form-label">Description</label>
                        <textarea class="form-control" id="position-description" rows="3"></textarea>
                    </div>
                </form>
            </div>
...
<script>
    ...
    function loadData() {
        ...
        fetch(`{{ url('/position/getData') }}?data=${encodeURIComponent(JSON.stringify(params))}`)
    ...
    function renderTable(positions) {
        ...
        tbody.innerHTML = positions.map((div, index) => `
            <tr>
        ...
        document.querySelectorAll('.btn-edit').forEach(btn => {
            btn.addEventListener('click', function() {
                editPosition(this.dataset.id, this.dataset.title, this.dataset.description);
            });
        });

        document.querySelectorAll('.btn-delete').forEach(btn => {
            btn.addEventListener('click', function() {
                deletePosition(this.dataset.id);
            });
        });
    }
    ...
    function editPosition(id, title, description) {
        ...
        document.getElementById('position-description').value = description;
        new bootstrap.Modal(document.getElementById('positionModal')).show();
    }
    ...
    document.getElementById('btn-save').addEventListener('click', function() {
        ...
        const url = id ? `{{ url('/position') }}/${id}` : '{{ url('/position') }}';
