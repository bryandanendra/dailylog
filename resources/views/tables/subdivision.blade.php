...
@section('title', 'Sub Division - Daily Log System')
...
@section('content')
<div class="pagetitle">
    <h1 class="text-capitalize">Sub Division</h1>
</div>
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Sub Division</li>
    </ol>
</nav>
    ...
    <div class="row">
        <div class="card">
            <div class="card-body pt-3">
                <h4 class="text-capitalize mb-4">Manage Sub Division</h4>
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <div class="d-flex gap-2">
                        <button type="button" id="btn-add" class="btn btn-sm btn-primary"><i class="bi bi-plus-lg"></i>&nbsp;Add Sub Division</button>
                    </div>
                    <div class="search-bar">
                        <div class="search-data d-flex align-items-center">
                            <input type="text" id="search" class="search" placeholder="Search Sub Division" title="Enter search keyword">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="subdivisionModalLabel">Add Sub Division</h5>
            ...
            <div class="modal-body">
                <form id="subdivisionForm">
                    ...
                    <div class="mb-3">
                        <label for="subdivision-description" class="form-label">Description</label>
                        <textarea class="form-control" id="subdivision-description" rows="3"></textarea>
                    </div>
                </form>
            </div>
...
<script>
    ...
    function loadData() {
        ...
        fetch(`{{ url('/subdivision/getData') }}?data=${encodeURIComponent(JSON.stringify(params))}`)
    ...
    function renderTable(subdivisions) {
        ...
        document.querySelectorAll('.btn-delete').forEach(btn => {
            btn.addEventListener('click', function() {
                deleteSubdivision(this.dataset.id);
            });
        });
    }
    ...
    document.getElementById('btn-add').addEventListener('click', function() {
        ...
        document.getElementById('subdivision-id').value = '';
    ...
    document.getElementById('btn-save').addEventListener('click', function() {
        ...
        const url = id ? `{{ url('/subdivision') }}/${id}` : '{{ url('/subdivision') }}';
